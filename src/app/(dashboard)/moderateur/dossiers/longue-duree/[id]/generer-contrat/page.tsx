...
export default function GenererContratModPage() {
  ...
  async function generer() {
    ...
    if (d.contrat_id) {
      ...
      router.push(`/moderateur/dossiers/longue-duree/${id}`)
  ...
  return (
    <div className="p-4 md:p-6 pb-nav max-w-xl mx-auto space-y-5">
      ...
      <div className="page-header">
        ...
        <p className="page-subtitle">Propriétaire a accepté — saisissez les conditions financières</p>
      </div>
      ...
      <div className="dashboard-card space-y-4">
        ...
        <div className="bg-primary-50 rounded-xl p-3 text-sm text-brun-doux">
          Commission LOFIA : 30% du premier loyer prélevé à la signature. Le locataire recevra un lien de paiement.
        </div>
